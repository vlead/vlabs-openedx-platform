...
* Port labs to Openedx (Ginkgo version)
  ...
  19. Push the tag
      ...
      #+END_EXAMPLE
  20. Rsync the exported course content into cloned
      repository
      #+BEGIN_EXAMPLE
      rsync -avz --progress <path-to-course-name-folder>/ <lab-name>/
      #+END_EXAMPLE
  21. Change directory to =<lab-name>= and push changes to
      github
      #+BEGIN_EXAMPLE
      cd <lab-name>
      git add <files>
      ...
      #+END_EXAMPLE
  22. Update the status and hosted url in the [[https://docs.google.com/spreadsheets/d/1JQRB_hGMcKkN05ZaEtgJpbi06k6OzP35m8xi9DhUMyI/edit#gid=367642649][excel sheet]]
      - Note :: 
