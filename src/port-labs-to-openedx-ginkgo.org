...
* Port labs to Openedx (Ginkgo version)
  ...
  17. Create a tag
      #+BEGIN_EXAMPLE
      git tag -a v1.0.0 -m "opnedx-dogwood-version"
      #+END_EXAMPLE
  ...
  22. Update status and hosted url in the [[https://docs.google.com/spreadsheets/d/1JQRB_hGMcKkN05ZaEtgJpbi06k6OzP35m8xi9DhUMyI/edit#gid=367642649][excel sheet]]
